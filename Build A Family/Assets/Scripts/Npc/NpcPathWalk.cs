...
public class NpcPathWalk : MonoBehaviour
{
    ...
    [SerializeField] GameObject Jake;
     ...
     private Vector3 initialPivotPosition = new Vector3(-26.04f, -0.2332252f, -0.85f); //0

    private Vector3 firstPivotPosition = new Vector3(4.56f, -0.2332252f, 1.01f); //1+

    private Vector3 secondPivotPosition = new Vector3(-15, -0.2332252f, 11); //2 +

    private Vector3 thirdPivotPosition = new Vector3(-9, 0, -5); //3
